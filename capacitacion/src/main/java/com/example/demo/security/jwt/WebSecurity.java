...
import static com.example.demo.security.Constants.TEST_URL;
import static com.example.demo.security.Constants.API_DOCS;
	...
	SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity
			...
			.authorizeHttpRequests( auth -> {
				auth.requestMatchers(LOGIN_URL,TEST_URL, ACTUATOR_URL, API_DOCS, SWAGGER_UI).permitAll();
